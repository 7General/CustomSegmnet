...
- (void)commonSetup
{
    ...
    v.backgroundColor = YSColor(220, 220, 220);
    [self addSubview:v];
    ...
    for (int i = 0; i < [_items count]; i++)
    {
      ...
      forControlEvents:UIControlEventTouchUpInside];
        ...
        if (i > 0)
        {
            ...
            line.backgroundColor = YSColor(220, 220, 220);
            //[UIColor colorWithRGBHex:0xdcdcdc];
...
- (UIColor *)getBtnColorAtIndex:(NSInteger)index
{
    ...
    {
        return YSColor(252, 124, 38);
    }
    else
    {
        return YSColor(112, 112, 112);
    }
}
